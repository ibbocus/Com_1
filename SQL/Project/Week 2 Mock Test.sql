...
,e.LastName
FROM Employees e
WHERE (e.TitleOfCourtesy NOT LIKE 'Mrs.' AND E.TitleOfCourtesy NOT LIKE 'Ms.')
...
,c.Country
FROM Customers c
WHERE c.Country LIKE 'Mexico' OR (c.Country LIKE 'Spain' AND c.City NOT LIKE 'MADRID')
...
SELECT e.Title, COUNT(*) as "Number of Employees sharing Job titles"
FROM Employees e
GROUP BY e.Title
...
WHERE (o.OrderDate > 01/01/1998) AND (o.ShippedDate > o.RequiredDate)
...
SELECT od.ProductID
,SUM(od.Quantity) AS "Total Quantity of Products ordered"
...
SELECT c.CustomerID
,COUNT(o.OrderID) AS "Number of Orders Made"
FROM Customers c
